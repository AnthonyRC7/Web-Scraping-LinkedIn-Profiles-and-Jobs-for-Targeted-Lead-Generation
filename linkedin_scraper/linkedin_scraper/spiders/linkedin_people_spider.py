...
#         profile_list = ['olive-kelechi-ebubeogu-8b2b0b232']
...
#         item = {'profile': response.meta['profile'], 'url': response.meta['linkedin_url']}
#
#         """
#             SUMMARY SECTION
#         """
...
# INTEGRATION WITH SCRAPING BEE***********************************************
import scrapy
from scrapy_scrapingbee import ScrapingBeeSpider, ScrapingBeeRequest


class LinkedInPeopleProfileSpider(ScrapingBeeSpider):
    name = "linkedin_people_profile"

    def start_requests(self):
        profile_list = ['anthony-remichris']

        for profile in profile_list:
            linkedin_people_url = f'https://www.linkedin.com/in/{profile}/'
            yield ScrapingBeeRequest(url=linkedin_people_url,
                                     params={
                                         'stealth_proxy': True,
                                         'render_js': True,
                                     },
